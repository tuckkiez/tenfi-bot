...
def send_message(message):
  for recipient_id in listofids:
    ...
    'ผู้ใช้งานเพียงแค่เตรียม BUSD หรือ BNB เท่านั้น หลังจากนั้นเลือกแผนการลงทุนที่ต้องการ เมื่อเลือกเสร็จ Yieldex จะทำการแบ่งเงินลงทุนออกเป็นส่วนๆ และผูก LP หลายๆตัวตามแผนการลงทุนที่เราเลือก โดยจะได้ผลตอบแทนเป็นการ auto compond ในทุกๆ LP และได้ TENFI เป็นรางวัลเสริม\n\n'
    ...
    'เหมาะกับ คนที่ต้องการสร้าง yield แต่ยังไม่ชำนาญ และคนที่ต้องการลงทุนหลายๆคู่ LP แต่ไม่อยากเสียเวลาสร้าง LP ลดเวลาการจัดการให้เหลือแค่ไม่กี่คลิก\n\n'
